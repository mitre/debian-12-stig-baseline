...
#
# Defaults to the official Debian 12 (bookworm) "genericcloud" image published
...
#
# Optional env:
#   DEBIAN_IMAGE_URL -- full URL to a .qcow2 (default: latest bookworm genericcloud amd64)
# Optional args:
